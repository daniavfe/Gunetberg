...
namespace Gunetberg.Cli
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            var userId = Guid.Parse("DBA7433E-F36B-1410-8E72-0088A96DEBA5");
            ...
            var postWithTags = new CreatePostRequest
            {
                ...
                Tags = new List<Guid> {
                    Guid.Parse("EAA7433E-F36B-1410-8E72-0088A96DEBA5"),
                    Guid.Parse("EEA7433E-F36B-1410-8E72-0088A96DEBA5"),
                    Guid.Parse("F2A7433E-F36B-1410-8E72-0088A96DEBA5"),
                }
            };
            ...
            var t = Task.Run(async () =>
            {
                ...
                using (repositoryContext)
                {
                    ...
                    //await tagService.CreateTag(new CreateTagRequest { Name = "Technology" });
                    //await tagService.CreateTag(new CreateTagRequest { Name = "Environment" });
                    //await tagService.CreateTag(new CreateTagRequest { Name = "Gastronomy" });
