...
namespace Gunetberg.Repository.Migrations
{
    ...
    [Migration("20230717095224_author")]
            ...
            modelBuilder.Entity("Gunetberg.Repository.Entities.PostEntity", b =>
                {
                    b.Property<Guid>("Id")
                        ...
                        .HasDefaultValue(new Guid("74dab7e0-3d8d-4e28-9c97-ec074df5ad91"));
            ...
            modelBuilder.Entity("Gunetberg.Repository.Entities.TagEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasDefaultValue(new Guid("40f6a8c0-454f-4231-b831-a093820007e5"));
            ...
            modelBuilder.Entity("Gunetberg.Repository.Entities.UserEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasDefaultValue(new Guid("2fec2893-21cf-432e-84c6-6934d811fb83"));
